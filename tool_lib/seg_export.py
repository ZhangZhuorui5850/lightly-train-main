...
def export_filtered_dataset(
    ...
    *,
    ...
    avg_instances_per_image_min: float = 0.0,
    avg_instances_per_image_max: float = 0.0,
) -> Path:
    ...
    try:
        return _export_filtered_dataset_impl(
            ...
            avg_instances_per_image_min=avg_instances_per_image_min,
            avg_instances_per_image_max=avg_instances_per_image_max,
            _state=state,
        )
...
def run_export(args) -> None:
    ...
    export_root = export_filtered_dataset(
        ...
        avg_instances_per_image_min=args.avg_instances_per_image_min,
        avg_instances_per_image_max=args.avg_instances_per_image_max,
    )
